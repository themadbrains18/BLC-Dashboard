        ...
        <Grid container spacing={2} sx={{ padding: '24px 24px' }}>
                ...
                <Card sx={{ minWidth: '30%', textAlign: 'center', background: '#ffa7261f', borderRadius: '10px' }}>
                    <CardContent>
                        <Box sx={{ marginBottom: '18px' }}>
                            <Typography sx={{ textAlign: 'start', fontSize: '20px' }}>Today Requests</Typography>
                        </Box>
                        <Box >
                            <Stack direction="row" sx={{ justifyContent: 'space-between', }}>
                                <Typography sx={{ fontSize: '14px' }}>Requests</Typography>
                        ...
                        <Box >
                            <Stack direction="row" sx={{ justifyContent: 'space-between', }}>
                                ...
                                <Typography sx={{ textAlign: 'start', fontSize: '12px' }}>Solved Requests: 219</Typography>
                            </Stack>
                        </Box>
            ...
            <Grid item xs={12} sm={6} md={4}>
                <Card sx={{ minWidth: '30%', textAlign: 'center', background: '#0288d11f', borderRadius: '10px' }}>
                    <CardContent>
                        <Box sx={{ marginBottom: '18px' }}>
                            <Typography sx={{ textAlign: 'start', fontSize: '20px' }}>This Week Requests</Typography>
                        </Box>
                        <Box >
                            <Stack direction="row" sx={{ justifyContent: 'space-between', }}>
                        ...
                        <Box >
                            <Stack direction="row" sx={{ justifyContent: 'space-between', }}>
                                ...
                                <Typography sx={{ textAlign: 'start', fontSize: '12px' }}>Solved Requests: 350</Typography>
                            </Stack>
                        </Box>
            ...
            <Grid item xs={12} sm={6} md={4}>
                <Card sx={{ minWidth: '30%', textAlign: 'center', background: '#f443361f', borderRadius: '10px' }}>
                    <CardContent>
                        <Box sx={{ marginBottom: '18px' }}>
                            <Typography sx={{ textAlign: 'start', fontSize: '20px' }}>This Month Requests</Typography>
                        </Box>
                        <Box >
                            <Stack direction="row" sx={{ justifyContent: 'space-between', }}>
                                <Typography sx={{ fontSize: '14px' }}>Requests</Typography>
